...
namespace Utils {
    ...
    void checkBeaconInterval() {
        ...
        if (beaconUpdate) {
            ...
            if (sendStartTelemetry && Config.battery.sendVoltageAsTelemetry && (Config.battery.sendInternalVoltage || Config.battery.sendExternalVoltage)) {
